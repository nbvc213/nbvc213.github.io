---
title: "GitHub + Typora 建立云笔记 (2024)"
layout: post
author: "nbvc213"
...
打开 [Jekyll Themes](http://jekyllthemes.org/) 官网，选择一个主题。一般来说，点击 `Homepage` 进入 `GitHub` 仓库界面，在 README 文档中有使用方法。
...
3. 在文件的开头添加 **YAML 前缀**。YAML 前缀包含了 4 个键值对，但是需要注意，YAML 前缀中的空格不能省略。
