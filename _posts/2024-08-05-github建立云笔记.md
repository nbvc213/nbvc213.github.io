---
title: "GitHub Page + Jekyll 建立云笔记"
layout: post
date: 2024-08-05
categories: 杂项笔记
math: true
...
其中，`GITHUB-PAGES-VERSION` 的值对应 `github-pages` 的版本号（此时为 232），版本号需要查询网页 [Dependency versions: GitHub Pages](https://pages.github.com/versions/)。
...
将本地仓库的 `main` 分支推送到远程仓库 `origin` 中的 `master` 分支。
